...
class MyInterface extends CGFinterface {
    ...
    init(application) {
        ...
        this.gui.add(this.scene, 'scaleFactorVehicle', 0.5, 3.0).name('scaleFactor');
        this.gui.add(this.scene, 'speedFactorVehicle', 0.1, 3.0).name('speedFactor');

        //--------------------------------
        
        this.gui.add(this.scene, 'selectedLandScape', this.scene.landScapeIds).name('Selected Landscape');
